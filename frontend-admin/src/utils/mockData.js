...
export const culturalResources = [
  {
    ...
    cover: 'https://images.unsplash.com/photo-1551029506-0807df4e2031?w=400&h=300&fit=crop',
    description: {
...

  {
    ...
    cover: 'https://images.unsplash.com/photo-1583225173760-4f7d82e888d0?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'yao',
    region: { zh: '桂林', en: 'Guilin', za: 'Gveiling' },
    cover: 'https://images.unsplash.com/photo-1590736969955-71cc94901144?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'miao',
    region: { zh: '柳州', en: 'Liuzhou', za: 'Liujcouh' },
    cover: 'https://images.unsplash.com/photo-1515562141589-67f0d569b6fc?w=400&h=300&fit=crop',
    description: {
...

  {
    ...
    cover: 'https://images.unsplash.com/photo-1599707367812-042e4c84e6e1?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'dong',
    region: { zh: '三江', en: 'Sanjiang', za: 'Samgyangh' },
    cover: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1590179068383-b9c69aacebd3?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'zhuang',
    region: { zh: '南宁', en: 'Nanning', za: 'Nanzningz' },
    cover: 'https://images.unsplash.com/photo-1533669955142-6a73332af4db?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'yao',
    region: { zh: '桂林', en: 'Guilin', za: 'Gveiling' },
    cover: 'https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=400&h=300&fit=crop',
    description: {
  ...
  },
  {
    ...
    ethnicity: 'dong',
    region: { zh: '三江', en: 'Sanjiang', za: 'Samgyangh' },
    cover: 'https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?w=400&h=300&fit=crop',
    description: {
...
export const inheritors = [
  {
    ...
    works: [
      { title: { zh: '凤凰牡丹图', en: 'Phoenix Peony Painting', za: 'Funghvangz Mujdanh Duz' }, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=300&h=200&fit=crop' },
      { title: { zh: '壮锦屏风', en: 'Zhuang Brocade Screen', za: 'Cuenghgim Bingzfungh' }, image: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=300&h=200&fit=crop' },
      { title: { zh: '壮锦壁挂十二生肖', en: 'Zodiac Brocade Wall Hanging', za: 'Cuenghgim Biggvaq Cib Ngeih Swnghsiuj' }, image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '布洛陀经诗录音整理', en: 'Buluotuo Poems Audio Archive', za: 'Bujlozdoz Ginghsi Luzim Cingjlij' }, image: 'https://images.unsplash.com/photo-1551029506-0807df4e2031?w=300&h=200&fit=crop' },
      { title: { zh: '经诗传习教材', en: 'Scripture Teaching Materials', za: 'Ginghsi Cwnzsiz Gyaucaiz' }, image: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '盘瑶盛装', en: 'Pan Yao Ceremonial Dress', za: 'Banyauz Swnghcangj' }, image: 'https://images.unsplash.com/photo-1590736969955-71cc94901144?w=300&h=200&fit=crop' },
      { title: { zh: '瑶族绣花鞋', en: 'Yao Embroidered Shoes', za: 'Bouxyauz Siujfaj Haiz' }, image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=300&h=200&fit=crop' },
      { title: { zh: '挑花围裙', en: 'Cross-stitch Apron', za: 'Diaujfaj Veizginz' }, image: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '苗族银冠', en: 'Miao Silver Crown', za: 'Bouxyouz Ngaenzgvanh' }, image: 'https://images.unsplash.com/photo-1515562141589-67f0d569b6fc?w=300&h=200&fit=crop' },
      { title: { zh: '银项圈', en: 'Silver Necklace', za: 'Ngaenz Hanghgienz' }, image: 'https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=300&h=200&fit=crop' },
      { title: { zh: '银手镯套装', en: 'Silver Bracelet Set', za: 'Ngaenz Sujcoz Daujcangj' }, image: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '程阳风雨桥修复', en: 'Chengyang Bridge Restoration', za: 'Cwngzyangz Funghyij Giuz Siujfug' }, image: 'https://images.unsplash.com/photo-1599707367812-042e4c84e6e1?w=300&h=200&fit=crop' },
      { title: { zh: '三江鼓楼', en: 'Sanjiang Drum Tower', za: 'Samgyangh Gujlauz' }, image: 'https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '侗族大歌进校园', en: 'Grand Song in Schools', za: 'Daihgoj Hawj Hauzyen' }, image: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=300&h=200&fit=crop' },
      { title: { zh: '大歌传承基地', en: 'Grand Song Heritage Base', za: 'Daihgoj Cwnzcenz Gihdeih' }, image: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '长鼓舞进校园', en: 'Drum Dance in Schools', za: 'Canghguj Vuj Hawj Hauzyen' }, image: 'https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=300&h=200&fit=crop' },
      { title: { zh: '盘王节领舞', en: 'Pan Wang Festival Lead Dance', za: 'Banzvangh Ciet Linghvuj' }, image: 'https://images.unsplash.com/photo-1504609813442-a8924e83f76e?w=300&h=200&fit=crop' }
    ]
  },
  {
    ...
    works: [
      { title: { zh: '铜鼓博物馆讲解', en: 'Museum Guided Tour', za: 'Dungzguj Bozvuzgvanh Gangjgaij' }, image: 'https://images.unsplash.com/photo-1590179068383-b9c69aacebd3?w=300&h=200&fit=crop' },
      { title: { zh: '铜鼓演奏教学', en: 'Drum Performance Teaching', za: 'Dungzguj Yenjcou Gyaujhag' }, image: 'https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?w=300&h=200&fit=crop' }
    ]
  }
]
